    ...
    return (
        <div className="ShopItemDiv">
            <div className="ListSection">
                ...
                <p className='ListCheckbox'><input type={"checkbox"} defaultValue="Headwear" onChange={Filter}/><p>&nbsp;Headwear</p></p>
                <p className='ListCheckbox'><input type={"checkbox"} defaultValue="Top" onChange={Filter}/><p>&nbsp;Top</p></p>
                <p className='ListCheckbox'><input type={"checkbox"} defaultValue="Bottom" onChange={Filter}/><p>&nbsp;Bottom</p></p>
                <p className='ListCheckbox'><input type={"checkbox"} defaultValue="Shoe" onChange={Filter}/><p>&nbsp;Shoe</p></p>

            </div>
            
            <div className="ItemSection">
                <div className='ItemToptab'>
                    <h1 className='ItemTextHead'>Category " Fashion "</h1>
